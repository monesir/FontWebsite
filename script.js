...
const uiTranslations = {
  ar: {
    ...
    faq_a6: "نعم! يحتوي الموقع على <strong>وضع المستند (Word)</strong>. يمكنك كتابة صفحات كاملة، وتنسيق النص، واختيار نوع الورق، وتصدير الملف بصيغة Word (DOCX) أو PDF أو صفحة ويب (HTML).",
    ...
    faq_a8: "بالتأكيد! في الإعدادات المتقدمة يمكنك تغيير لون النص بالكامل. كما يمكنك إخفاء الحركات بضغطة زر (ليتم شبك الحروف بسلاسة) أو تلوين الحركات بلون مختلف عن النص الأساسي لتجميل المخطوطات.",
