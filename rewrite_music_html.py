...
new_music_html = """              <!-- Music App Content (Zolitune Premium) -->
              <div class="ios-app" id="app-music" style="background: #0a0a0c;">
                ...
                <div class="zoli-glass-bottom" id="zoliBottomContainer">
                  ...
                  <div class="zoli-nav-premium">
                    ...
                    <div class="zoli-nav-item" onclick="openZoliScreen('home')">
                      <img src="https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?q=80&w=50&auto=format&fit=crop" class="zoli-nav-spotify-logo" style="border-radius: 50%; width: 24px; height: 24px;">
                      <span>Premium</span>
                    </div>
                  </div>
                </div>
...
start_idx = html.find('<!-- Music App Content (Zolitune) -->')
if start_idx == -1:
    start_idx = html.find('<!-- Music App Content (Zolitune Premium) -->')

end_idx = html.find('<!-- END OF MUSIC APP -->')
if end_idx == -1:
    # If the end tag doesn't exist, we look for the next ios-app or the end of apps container
    end_idx = html.find('</div>\n\n            </div>\n\n            <!-- END of IOS SCREEN -->')

if start_idx != -1 and end_idx != -1:
    html = html[:start_idx] + new_music_html + "\n                <!-- END OF MUSIC APP -->\n" + html[end_idx:]
else:
